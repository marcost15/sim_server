...
function content_619e306284ddc4_60436764 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
	<ul class="nav nav-tabs">
		...
		<li class="nav-item"><a class="nav-link" href="user_password.php?"><?=_('Add administrator')?></a></li>
		<li class="nav-item"><a class="nav-link" href="user_password.php?"><?=_('Modify others')?></a></li>
	</ul>
