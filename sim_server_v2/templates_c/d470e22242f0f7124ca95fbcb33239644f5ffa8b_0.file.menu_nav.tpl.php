...
function content_6193ce20ebf805_88588184 (Smarty_Internal_Template $_smarty_tpl) {
...
&nbsp;<?=_('User')?>
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownd">
            <li><a class="dropdown-item" href="user_password.php"><?=_('Change')?></a></li>
            <li><a class="dropdown-item" href="user_others.php"><?=_('Manage')?></a></li>
