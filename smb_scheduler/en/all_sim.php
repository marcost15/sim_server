...
if(isset($_GET['action'])) {
	...
	elseif($action=="savemodify")
	{
		...
		if($sim_rs['month_limit_time']!=$_POST['month_limit_time']) {
			...
			$t_remain.=",month_remain_time=$_POST[month_limit_time],month_last_reset_time=now()";
		}
...
*/
	...
	elseif($action=="savemoremodify")
	{
		...
		if($ErrMsg!="")
			...
			if($_POST['month_limit_time_modify']) $sql.="month_limit_time='$_POST[month_limit_time]',month_remain_time='$_POST[month_limit_time]',month_last_reset_time=now(),";
